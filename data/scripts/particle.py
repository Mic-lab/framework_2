...
class Particle(MovableObject):
    ...
    def __init__(self, random_change, vel_randomness, pos, vel, friction, inital_img, alpha, changed_alpha, changed_size, max_vel=None, size=1):
        ...
        self.inital_img = inital_img.convert()
        self.inital_img.set_colorkey(colorkey)
